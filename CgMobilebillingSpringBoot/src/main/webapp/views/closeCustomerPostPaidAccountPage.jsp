...
<title>close Customer PostPaid Account</title>
</head>
<body>
	<h2><a href="indexPage">Home Page</a></h2>
<header>
	<h1 align="center">close Customer PostPaid Account</h1>

	</header>
	<section>
	<form action="closeCustomerPostPaidAccountSuccessful" method="post">
