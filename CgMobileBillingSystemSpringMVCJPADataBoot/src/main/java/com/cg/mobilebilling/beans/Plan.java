...
public class Plan {
	...
	@SequenceGenerator(name="planIDGenerator", sequenceName="planId_seq", initialValue=1001, allocationSize=0)
	private int planID;
	...
	@NotEmpty(message= "{NotEmpty.plan.planCircle}")
	private String planCircle;
	@NotEmpty(message= "{NotEmpty.plan.planName}")
